  ...
  const typeMap: any = {
    ...
    Map: o(
      [
        ...
        {
          json: 'mapTextureCorners',
          js: 'mapTextureCorners',
          typ: a(r('Border')),
        },
    ...
    Assets: o(
      [
        {
          json: 'vehicleSpawners',
          js: 'vehicleSpawners',
          typ: a(r('VehicleSpawner')),
        },
    ...
    CapturePoints: o(
      [
        ...
        {
          json: 'objectiveSpawnLocations',
          js: 'objectiveSpawnLocations',
          typ: a(r('Border')),
        },
        {
          json: 'destructionObject',
          js: 'destructionObject',
          typ: r('DestructionObject'),
        },
      ],
      false
    ),
    Clusters: o(
      [
        ...
        { json: 'numberOfPoints', js: 'numberOfPoints', typ: u(undefined, 0) },
        {
          json: 'listOfMains',
          js: 'listOfMains',
          typ: u(undefined, a(r('ClustersListOfMain'))),
        },
        {
          json: 'objectives',
          js: 'objectives',
          typ: u(undefined, a(r('ObjectiveElement'))),
        },
      ],
      false
    ),
      ...
      [
        {
          json: 'attackingTeam',
          js: 'attackingTeam',
          typ: u(undefined, r('AttackingTeam')),
        },
        {
          json: 'delayBetweenPhases',
          js: 'delayBetweenPhases',
          typ: u(undefined, 0),
        },
        { json: 'objectiveClass', js: 'objectiveClass', typ: u(undefined, '') },
        {
          json: 'roundTimerIncrease',
          js: 'roundTimerIncrease',
          typ: u(undefined, 0),
        },
        {
          json: 'timerIncreasePerPhaseActive',
          js: 'timerIncreasePerPhaseActive',
        ...
        { json: 'phases', js: 'phases', typ: u(undefined, a(r('Phase'))) },
        {
          json: 'noDeployZones',
          js: 'noDeployZones',
          typ: u(undefined, a(r('NoDeployZone'))),
        },
      ],
      false
    ),
    ...
    Phase: o(
      [
        ...
        {
          json: 'phaseObjectives',
          js: 'phaseObjectives',
          typ: a(r('PhaseObjective')),
        },
      ],
      false
    ),
    PhaseObjective: o(
      [
        ...
        {
          json: 'minDistanceBetweenSpots',
          js: 'minDistanceBetweenSpots',
          typ: 0,
        },
    ...
    Hexs: o(
      [
        ...
        {
          json: 'startRandomAnchorDist:',
          js: 'startRandomAnchorDist:',
          typ: u(undefined, 3.14),
        },
        {
          json: 'endRandomAnchorDist:',
          js: 'endRandomAnchorDist:',
          typ: u(undefined, 3.14),
        },
    ...
    Lanes: o(
      [
        ...
        { json: 'listOfLanes', js: 'listOfLanes', typ: u(undefined, a('')) },
        {
          json: 'laneObjects',
          js: 'laneObjects',
          typ: u(undefined, m(r('LaneObject'))),
        },
      ],
      false
    ),
    ...
    MapAssets: o(
      [
        {
          json: 'protectionZones',
          js: 'protectionZones',
          typ: a(r('ProtectionZone')),
        },
    ...
    ProtectionZone: o(
      [
        ...
        {
          json: 'deployableLockDistance',
          js: 'deployableLockDistance',
          typ: 0,
        },
    ...
    ObjectiveValue: o(
      [
        ...
        { json: 'location_z', js: 'location_z', typ: u(undefined, 3.14) },
        {
          json: 'objects',
          js: 'objects',
          typ: u(undefined, a(r('PointObject'))),
        },
        { json: 'pointPosition', js: 'pointPosition', typ: 0 },
        {
          json: 'avgLocation',
          js: 'avgLocation',
          typ: u(undefined, r('Border')),
        },
    ...
    AttackingTeam: ['Team Neutral', 'Team One', 'Team Two'],
    DeployableType: [
      'Ammo Crate',
    ...
    Size: ['APC', 'Bike', 'Boat', 'Car', 'Helicopter', 'MBT', 'QuadBike'],
    VehType: [
      'APC',
      'IFV',
      'LOGI',
